...
const std::string INCLUDED_THEME_FOLDER_URL = "https://raw.githubusercontent.com/glitched-nx/UltraHAND/main/themes/";
const std::string LATEST_RELEASE_INFO_URL = "https://raw.githubusercontent.com/ppkantorski/UltraHAND/main/RELEASE.ini";
